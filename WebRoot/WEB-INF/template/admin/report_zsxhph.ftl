 	...
 	<script type="text/javascript">
        $(function (){
            ...
            var grid = $("#maingrid").ligerGrid({
                ...
                parms:{
                	reportName:'GamePointConsumeRankReport',
                	beginDate:$.date.getFormatDate(beginDate,'yyyyMMdd'),
                	server:1
                },
                sortName: 'id', 
                columns: [
                    { display: '排名', name: 'rank',width: parseInt(width*0.1),title: '排名'},
                    { display: '角色名', name: 'roleName',width: parseInt(width*0.1),title: '角色名'},
                    { display: 'ID', name: 'roleId',width: parseInt(width*0.1),title: 'ID'},
                    { display: '消耗钻石数量', name: 'consumePoint',width: parseInt(width*0.1),title: '消耗钻石数量'},
					{ display: '角色创建时间', name: 'createTime',width: parseInt(width*0.1),title: '角色创建时间'},
					{ display: '角色最近登录时间', name: 'lastLoginTime',width: parseInt(width*0.1),title: '角色最近登录时间'}					
                ],
                width:'100%',
                height:'100%',
                heightDiff:-2,
            ...
            $("#searchButton").click(function(){
            	...
            	form.reportName ='GamePointConsumeRankReport';

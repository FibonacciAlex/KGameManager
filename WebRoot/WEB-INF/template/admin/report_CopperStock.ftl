 	...
 	<script type="text/javascript">
        $(function (){
            ...
            var grid = $("#maingrid").ligerGrid({
                ...
                parms:{
                	reportName:'GameCopperStockReport',
                ...
                columns: [
	                ...
	                { display: '新增铜币', name: 'produceCopper',width: parseInt(width*0.1),title: '所选日期区间每日系统所新增加的铜币数量'},
	                { display: '消耗铜币', name: 'consumeCopper',width: parseInt(width*0.1),title: '所选日期区间每日系统所消耗的铜币数量'},
	                { display: '库存铜币', name: 'stockCopper',width: parseInt(width*0.1),title: '服务器剩余的未消耗银两'}
                ],
                width:'100%',
                height:'100%',
                heightDiff:-2,
            ...
            $("#searchButton").click(function(){
            	...
            	form.reportName ='GameCopperStockReport';

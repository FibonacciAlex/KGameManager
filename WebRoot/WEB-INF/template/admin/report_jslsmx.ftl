 	...
 	<script type="text/javascript">
        $(function (){
            ...
            var grid = $("#maingrid").ligerGrid({
                ...
                parms:{
                	reportName:'RoleLossReport',
                	beginDate:$.date.getFormatDate(beginDate,'yyyyMMdd'),
                	server:1
                },
                sortName: 'id', 
                columns: [
                    { display: '排名', name: 'rank',width: parseInt(width*0.08),title: '排名'},
	                { display: '任务ID', name: 'missionId',width: parseInt(width*0.08),title: '任务ID'},
	                { display: '完成任务角色数', name: 'completeCount',width: parseInt(width*0.08),title: '完成任务角色数'},
	                { display: '完成率', name: 'completeRate',width: parseInt(width*0.1),title: '完成该任务人数/该等级以上所有玩家数*100%'}	  	
                ],
                width:'100%',
                height:'100%',
                heightDiff:-2,
            ...
            $("#searchButton").click(function(){
            	...
            	form.reportName ='RoleLossReport';

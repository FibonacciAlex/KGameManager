 	...
 	<script type="text/javascript">
        $(function (){
            ...
            var grid = $("#maingrid").ligerGrid({
                ...
                parms:{
                	reportName:'RoleOccupationReport',
                ...
                sortName: 'id', 
                columns: [
                    { display: '职业', name: 'occName',width: parseInt(width*0.1),title: '角色的职业'},
	                { display: '人数', name: 'occCount',width: parseInt(width*0.1),title: '所选职业的角色总数'},
	                { display: '占比', name: 'occRate',width: parseInt(width*0.1),title: '（当前职业人数分布/当天创建的所有职业角色总数）*100%'}
                ],
                width:'100%',
                height:'100%',
                heightDiff:-2,
            ...
            $("#searchButton").click(function(){
            	...
            	form.reportName ='RoleOccupationReport';

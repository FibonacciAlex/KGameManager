 	...
 	<script type="text/javascript">
        $(function (){
            ...
            var grid = $("#maingrid").ligerGrid({
                ...
                parms:{
                	reportName:'FirstFunConsumeReport',
                	beginDate:$.date.getFormatDate(beginDate,'yyyyMMdd'),
                	server:1
                },
                sortName: 'id', 
                columns: [
                    { display: '途径', name: 'funName',width: parseInt(width*0.2),title: '途径'},
                    { display: '人次', name: 'roleCount',width: parseInt(width*0.1),title: '人次'},
                    { display: '消耗钻石量', name: 'consumePoint',width: parseInt(width*0.1),title: '消耗钻石量'}				
                ],
                width:'100%',
                height:'100%',
                heightDiff:-2,
            ...
            $("#searchButton").click(function(){
            	...
            	form.reportName ='FirstFunConsumeReport';

 	...
 	<script type="text/javascript">
        $(function (){
            ...
            var grid = $("#maingrid").ligerGrid({
                ...
                parms:{
                	reportName:'GamePointStockReport',
                ...
                sortName: 'id', 
                columns: [
                    { display: '日期', name: 'reportDate',width: parseInt(width*0.1),title: '日期'},
	                { display: '新增元宝', name: 'chargePoint',width: parseInt(width*0.1),title: '所选日期区间每日系统所新增加的充值元宝数量'},
	                { display: '新增赠送元宝', name: 'presentPoint',width: parseInt(width*0.1),title: '所选日期区间每日系统赠送的元宝数量'},
	                { display: '消耗元宝', name: 'consumePoint',width: parseInt(width*0.1),title: '所选日期区间每日系统所消耗的元宝数量'},
	                { display: '库存元宝', name: 'stockPoint',width: parseInt(width*0.1),title: '服务器剩余未消耗元宝'}
                ],
                width:'100%',
                height:'100%',
                heightDiff:-2,
            ...
            $("#searchButton").click(function(){
            	...
            	form.reportName ='GamePointStockReport';

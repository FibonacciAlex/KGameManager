...
infosoftglobal.FusionCharts.prototype = {
	...
	addVariables:function(object){
		for(var key in object) {
			this.addVariable(key, object[key]);
		}
	},
	...
	render: function(elementId,printVisible){
		...
		if((this.detectFlashVersion==1) && (this.installedVer.major < 8)){
			...
			if((typeof jQuery!="undefined")&&jQuery.fn.printDiv&&this.params["printdiv"]!='0'){
				  jQuery("#"+elementId).printDiv();
			}

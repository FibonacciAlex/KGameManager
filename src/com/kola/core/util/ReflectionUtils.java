...
public class ReflectionUtils {
	 ...
	 */
	@SuppressWarnings("unchecked")
	private static void findFields(Class<?> clazz, List fields) {
	...
	public static Method[] getMethods(Class<?> clazz) {
		...
		List fields = new ArrayList();
		while (Object.class!= clazz) {
			findMethods(clazz, fields);
			clazz = clazz.getClass().getSuperclass();
		}
		return (Method[]) fields.toArray(new Method[fields.size()]);
	}

	@SuppressWarnings("unchecked")
	private static void findMethods(Class<?> clazz, List fields) {

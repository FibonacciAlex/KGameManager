...
public interface GamePointConsumeRankReportDAO {
	/**
	 * <pre>
	 * 查询游戏全部区或者某个区的元宝功能消耗排行报表数据
	 * 有效的查询条件:
	 ...
	 * </pre>
	 */	
	public GamePointConsumeRankReport getGamePointConsumeRankReport(Map<String,String> condition);
}
